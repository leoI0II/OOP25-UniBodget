 ...
 *
 * <p>This deserializer only reads the currency code from JSON.
 * The actual lookup (mapping code → Currency instance) is performed
 * later by {@link Currency#init()} when all currencies are loaded.</p>
 *
 * <p>This avoids recursive initialization loops during JSON parsing.</p>
 */
