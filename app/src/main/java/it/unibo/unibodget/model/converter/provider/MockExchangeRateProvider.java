...
public class MockExchangeRateProvider implements ExchangeRateProvider {
    ...
    private static final Map<Pair, BigDecimal> RATES = Map.ofEntries(
        ...
        Map.entry(new Pair(FiatCurrency.USD, FiatCurrency.CHF), new BigDecimal("0.90")),
        Map.entry(new Pair(FiatCurrency.CHF, FiatCurrency.USD), new BigDecimal("1.11")),
        // Crypto → Fiat
        ...
        Map.entry(new Pair(CryptoCurrency.USDT, FiatCurrency.EUR), new BigDecimal("0.92")),
        Map.entry(new Pair(FiatCurrency.USD, CryptoCurrency.USDT), new BigDecimal("1.01")),
        // Fiat → Crypto
