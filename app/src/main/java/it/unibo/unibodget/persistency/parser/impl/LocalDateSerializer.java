 ...
 *
 * <p>
 * This serializer converts a {@code LocalDate} into its ISO-8601 string
 * representation (e.g., "2024-05-17"). It ensures that date values are written
 * to JSON files in a consistent and interoperable format.
 * </p>
 *
 * <p>
 * The output format matches the default representation produced by
 * {@code LocalDate.toString()}, guaranteeing compatibility with the
 * corresponding {@code LocalDateDeserializer} used during JSON loading.
 * </p>
 */
