...
class ThemeTest {
    ...
    void shouldComputeReadableTextColor() {
        ARGBColor bright = new ARGBColor("#FFFFFF");
        ARGBColor dark = new ARGBColor("#000000");
    ...
    void shouldFallbackToDefaultFontSize() {
        Theme t = new Theme("X", ARGBColor.WHITE, ARGBColor.BLACK, ARGBColor.BLACK, "Arial", -5, false);
        assertEquals(Theme.DEFAULT.getFontSize(), t.getFontSize());
    }

    @Test
    void shouldStoreAllFields() {
        Theme t = new Theme("Test", "#FFFFFF", "#000000");
    ...
    void shouldCompareThemesCorrectly() {
        Theme t1 = new Theme("A", "#FFFFFF", "#000000");
        Theme t2 = new Theme("A", "#FFFFFF", "#000000");
